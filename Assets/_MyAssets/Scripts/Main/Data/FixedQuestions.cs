...
internal static class FixedQuestions
{
    ...
    // 事前生成のデータ
    private static readonly Dictionary<string, ReadOnlyCollection<(int[] Numbers, int Target, string Answer)>> data = new();
    ...
    {
        /*
        *  1 -  3 問目 2-1   数字２個、演算子1個
        *  4      問目 2-0   数字２個、演算子0個
        *  5 -  6 問目 3-0   数字３個、演算子0個
        *  7 - 10 問目 3-2-0 数字３個、演算子２個(+,- 2個)
        ...
        */
        ...
        int i = preparingQuestionIndex + 1; // 1始まりに変換
