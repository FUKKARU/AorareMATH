Shader "Custom/GrayscaledSpriteRenderer"
{
    Properties
    {
        // 追加
        [MaterialToggle] _GrayscaleEnabled("Grayscale Enabled", Float) = 0
        _GrayscaleStrength("Grayscale Strength", Range(1.0, 5.0)) = 1.0
